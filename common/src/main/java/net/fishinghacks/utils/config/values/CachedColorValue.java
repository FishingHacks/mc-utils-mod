...
public class CachedColorValue extends CachedMappedValue<Color, Integer> {
    protected CachedColorValue(Config config, ConfigValue<Integer> internalValue, ConfigBuilder builder) {
        super(config, internalValue, Color::argb, Color::fromARGB, builder);
    }

    public static CachedColorValue wrap(Config config, ConfigBuilder builder, String key, Color defaultValue) {
