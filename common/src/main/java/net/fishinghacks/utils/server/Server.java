...
import net.fishinghacks.utils.connection.packets.DisconnectPacket;
import net.fishinghacks.utils.connection.packets.InviteNotificationPacket;
import net.fishinghacks.utils.connection.packets.Packet;
import net.fishinghacks.utils.connection.packets.PacketHandler;
...
public class Server {
    ...
    public static @Nullable Server getInstance() {
        return instance;
    }

    public static void initialize(DedicatedServer dedicatedServer) {
        if (instance == null) instance = new Server(dedicatedServer);
        instance.run();
    }

    private Server(DedicatedServer server) {
