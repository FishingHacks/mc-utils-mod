...
@Module(name = "ping", category = ModuleCategory.UI)
public class Ping extends RenderableTextModule {
    ...
    public List<Component> getPreviewText() {
        return List.of(Component.literal("Ping: ").withStyle(ChatFormatting.GRAY)
            .append(Component.literal("0ms").withStyle(ChatFormatting.GREEN)));
    }
}
