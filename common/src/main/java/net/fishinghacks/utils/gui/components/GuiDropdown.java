...
public class GuiDropdown<T> extends AbstractWidget {
    ...
    protected void renderWidget(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        drawScrollingString(guiGraphics, Minecraft.getInstance().font, message, getX() + 3,
    ...
    protected void drawScrollingString(GuiGraphics graphics, Font font, Component text, int minX, int maxX, int y,
        ...
        if (textWidth <= maxWidth) {
            ...
            AbstractWidget.renderScrollingString(graphics, font, text, minX, y, maxX, y + font.lineHeight, color);
        }
    }
