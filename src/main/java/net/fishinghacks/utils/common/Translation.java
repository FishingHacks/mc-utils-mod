...
public enum Translation implements Supplier<Component> {
    ...
    CmdCalcOverworld("utils.cmd.calc.overworld"),
    CmdCalcNether("utils.cmd.calc.nether"),
    CmdCalcNetherOverworldUsage("utils.cmd.calc.nether_overworld_usage"),
    CmdCalcParseIntFailed("utils.cmd.calc.failed_to_parse_int"),
    CmdCalcParseCustomFuncRemoved("utils.cmd.calc.remove_custom_func"),
    CmdCalcCustomAddUsage("utils.cmd.calc.add_custom_usage"),
    CmdCalcCustomAdded("utils.cmd.calc.added_custom"),
    CmdCalcCraftResult("utils.cmd.calc.craft.result"),
    CmdCalcCraftOneOf("utils.cmd.calc.craft.one_of"),
    CmdCalcCraftNotFound("utils.cmd.calc.craft.no_recipe_found"),
    CmdCalcCraftMultiple("utils.cmd.calc.craft.multiple"),
    CmdCalcCraftUsage("utils.cmd.calc.craft.usage"),
    CmdCalcCraftEntry("utils.cmd.calc.craft.entry"),
    Error("utils.common.error"),
    ClickToCopy("utils.common.click_to_copy"),
