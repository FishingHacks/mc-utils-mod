...
public class Box extends UnfocusableWidget {
    ...
    public boolean hasTopBorder() { return borders.top; }
    public boolean hasBottomBorder() { return borders.bottom; }
    public boolean hasLeftBorder() { return borders.left; }
    public boolean hasRightBorder() { return borders.right; }
    public void setTopBorder(boolean top) { setBorders(borders.setTop(top)); }
    public void setBottomBorder(boolean bottom) { setBorders(borders.setBottom(bottom)); }
    public void setLeftBorder(boolean left) { setBorders(borders.setLeft(left)); }
    public void setRightBorder(boolean right) { setBorders(borders.setRight(right)); }
    ...
    public record Borders(boolean top, boolean bottom, boolean left, boolean right) {
        ...
        private boolean hasAny() { return top || bottom || left || right; }

        public Borders setLeft(boolean left) { return new Borders(top, bottom, left, right); }
        public Borders setRight(boolean right) { return new Borders(top, bottom, left, right); }
        public Borders setTop(boolean top) { return new Borders(top, bottom, left, right); }
        public Borders setBottom(boolean bottom) { return new Borders(top, bottom, left, right); }
        public Borders merge(Borders other) { return new Borders(top || other.top, bottom || other.bottom, left || other.left, right || other.right); }
    }
}
