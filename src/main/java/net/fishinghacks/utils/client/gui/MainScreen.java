...
public class MainScreen extends Screen {
    ...
    public static final Component MODS = Component.translatable("fml.menu.mods");
    ...
    protected void init() {
        ...
        y += this.addRenderableWidget(
            new Button.Builder(MODS).onPress(btn -> this.minecraft.setScreen(new ModListScreen(this))).pos(x, y)
                .width(180).build()).getHeight() + 8;
