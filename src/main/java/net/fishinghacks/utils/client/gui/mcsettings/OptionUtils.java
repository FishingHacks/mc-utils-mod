...
import net.fishinghacks.utils.client.gui.components.GuiDropdown;
import net.fishinghacks.utils.client.gui.components.Slider;
import net.fishinghacks.utils.client.gui.components.Toggle;
import net.fishinghacks.utils.client.gui.configuration.ConfigSection;
    ...
    private static @Nullable AbstractWidget fromValueSet(OptionInstance inst) {
        ...
        try {
            ...
            if (toSliderValue == null || fromSliderValue == null) {
                Utils.getLOGGER().info("Not enough methods found for {}", inst.caption);
                return null;
            }
            ...
            Utils.getLOGGER().info("Error for {}", inst.caption, e);
            return null;
        }
    }
